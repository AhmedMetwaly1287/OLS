        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RackNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Archives_BorrowedBooks_BorrowedBookRequestID",
                        column: x => x.BorrowedBookRequestID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Archives_BorrowedBookRequestID",
                table: "Archives",
                column: "BorrowedBookRequestID",
                unique: true);
